...
class WashingMachineSensor(CoordinatorEntity[WashingMachineCoordinator], SensorEntity):
    ...
    def extra_state_attributes(self) -> dict[str, Any]:
        ...
        return {
            ...
            "locked_program_slug": data.diagnostics.get("locked_program_slug"),
            "locked_program_label": data.diagnostics.get("locked_program_label"),
            "locked_program_score": data.diagnostics.get("locked_program_score"),
            "best_match_slug": data.diagnostics.get("best_match_slug"),
            "best_match_label": data.diagnostics.get("best_match_label"),
            "best_match_score": data.diagnostics.get("best_match_score"),
